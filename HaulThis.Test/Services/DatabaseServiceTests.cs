...
public class DatabaseServiceTests : IDisposable
{
    ...
    public void CreateConnection_WhenConnectionIsClosed_ShouldOpenConnectionAndReturnTrue()
    {
        ...
        // Act
        bool result = _subject.CreateConnection();
    ...
    public void Execute_WhenConnectionIsOpen_ShouldReturnNumberOfRowsAffected()
    {
        ...
        // Act
        int result = _subject.Execute("UPDATE SomeTable SET SomeColumn = @p0", "SomeValue");
        ...
        _mockLogger.Verify(
            x => x.Log(
                ...
                It.Is<It.IsAnyType>((v, t) =>
                    v.ToString() == "Executed command: UPDATE SomeTable SET SomeColumn = @p0"),
                It.IsAny<Exception>(),
                (Func<It.IsAnyType, Exception, string>)It.IsAny<object>()),
            Times.Once);
    }
    ...
    public void Execute_WhenCommandThrowsException_ShouldLogErrorAndThrowException()
    {
        ...
        Assert.Throws<InvalidOperationException>(() =>
            _subject.Execute("UPDATE SomeTable SET SomeColumn = @p0", "SomeValue"));
        ...
        _mockLogger.Verify(
            x => x.Log(
                ...
                It.IsAny<EventId>(),
                It.Is<It.IsAnyType>((v, t) =>
                    v.ToString() == "Failed to execute command: UPDATE SomeTable SET SomeColumn = @p0"),
    ...
    public void Query_WhenConnectionIsOpen_ShouldReturnDataReaderAndLogInformation()
    {
        ...
        Mock<IDbCommand> mockCommand = new Mock<IDbCommand>();
        Mock<DbDataReader> mockReader = new Mock<DbDataReader>();
    ...
    public void QueryRow_WhenRowExists_ShouldReturnDataRecordAndLogInformation()
    {
        ...
        _mockLogger.Verify(
            x => x.Log(
                ...
                It.IsAny<EventId>(),
                It.Is<It.IsAnyType>((v, t) =>
                    v.ToString() == "Query returned a row: SELECT * FROM SomeTable WHERE Id = @p0"),
                It.IsAny<Exception>(),
                (Func<It.IsAnyType, Exception, string>)It.IsAny<object>()),
            Times.Once);
    }
    ...
    public void QueryRow_WhenNoRowExists_ShouldReturnNullAndLogWarning()
    {
        ...
        _mockLogger.Verify(
            x => x.Log(
                ...
                It.IsAny<EventId>(),
                It.Is<It.IsAnyType>((v, t) =>
                    v.ToString() == "Query did not return any rows: SELECT * FROM SomeTable WHERE Id = @p0"),
                It.IsAny<Exception>(),
                (Func<It.IsAnyType, Exception, string>)It.IsAny<object>()),
            Times.Once);
    }
